<link href="https://fonts.googleapis.com/css?family=Nunito+Sans:200,400,700" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="css/folderAnimation/normalize.css" />
    <link rel="stylesheet" type="text/css" href="css/folderAnimation/demo.css" />
...
<div class="editor-sidebar">
    ...
    <div class="editor-sidebar-navigation">
                <div class="editor-sidebar-controls">
                    <button class="sidebar-btn btn btn-save btn-xl d-flex align-items-center">
                        <i class="far fa-save"></i> <span>Save</span>
                    </button>
                    <button class="sidebar-btn btn btn-new btn-xl d-flex align-items-center">
                ...
                <div class="editor-sidebar-stickers">
                    ...
                    <section class="content content--kubera sidebar-folder">
                        <div class="folder folder--kubera">
                            <div class="folder__icon folder__icon--perspective">
                                ...
                                <div class="folder__preview folder__preview--thumbs">
                                    <img class="folder__thumb" src="img/folderAnimation/photo9.png" />
                                    <img class="folder__thumb" src="img/folderAnimation/photo10.png" />
                                    <img class="folder__thumb" src="img/folderAnimation/photo11.png" />
                                    <img class="folder__thumb" src="img/folderAnimation/photo12.png" />
                                </div>
                            ...
                            <h3 class="folder__caption">Stickers</h3>
                        </div>
                        
                    </section>
                    <script src="js/folderAnimation/anime.min.js"></script>
                    <script src="js/folderAnimation/charming.min.js"></script>
                    <script src="js/folderAnimation/main.js"></script>
                    <script>
                        (function() {
                ...
                <div class="editor-sidebar-controls">
                    <button class="sidebar-btn btn btn-save btn-xl d-flex align-items-center">
                    <i class="fas fa-door-open"></i></i> <span>Home</span>
                    </button>
                    <button class="sidebar-btn btn btn-new btn-xl d-flex align-items-center">
