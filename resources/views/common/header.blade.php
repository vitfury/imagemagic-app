<nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container">
                            <a class="" href="index.html"><img class="logostyles" src="img/logo.png" height="96px" alt="logo"></a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><i data-feather="menu"></i></button>
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <a class="btn-primary btn rounded-pill px-4 ml-lg-4" href="https://shop.startbootstrap.com/sb-ui-kit-pro">Log-in/sign-in<i class="fas fa-arrow-right ml-1"></i></a>
                            </div>
                        </div>
                    </nav>
<<<<<<< HEAD
                            ...
                            <div class="container">
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-lg-6" data-aos="fade-right">
                                        ...
                                        <p class="page-header-text mb-5">Marketing pages for your mobile app have never been easier. Get started now!</p>
                                        <div class="mb-5 mb-lg-0">
                                            ...
                                            <div class="page-header-text mt-2 text-xs font-italic">* Requires Android OS 4.3+ or Apple iOS 9.3+</div>
                                        </div>
                                    </div>
...
>>>>>>> 8e5438cc2007b4216faf475fb90078332c73c791
