<header class="page-header page-header-dark bg-gradient-primary-to-secondary">
    ...
    <div class="svg-border-waves text-white">
        <svg class="wave" style="pointer-events: none" fill="#eff3f8" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 75">
            <defs>
                <style>
                    .a {
                        fill: none;
